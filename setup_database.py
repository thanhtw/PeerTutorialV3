...
def automated_database_setup():
    ...
    try:
        ...
        if 'create' in sql_files:
            if not execute_sql_file_automated(db, sql_files['create'], "Table Creation"):
        ...
        if 'insert' in sql_files:
            if not execute_sql_file_automated(db, sql_files['insert'], "Data Insertion"):
...
def main():
    ...
    # Run automated setup
    success = automated_database_setup()
