...
translations = {
    ...
    # Enhanced Tutorial Keys
    "array_out_of_bounds_explanation": "Array Out Of Bounds Explanation",
    "array_out_of_bounds_pattern_description": "Array Out Of Bounds Pattern Description",
    "array_out_of_bounds_tip": "Array Out Of Bounds Tip",
    "code_overview_content": "Code Overview Content",
    "code_overview_point_1": "Code Overview Point 1",
    "code_overview_point_2": "Code Overview Point 2",
    "code_overview_point_3": "Code Overview Point 3",
    "code_overview_title": "Code Overview Title",
    "completion_content": "Completion Content",
    "completion_point_1": "Completion Point 1",
    "completion_point_2": "Completion Point 2",
    "completion_point_3": "Completion Point 3",
    "completion_title": "Completion Title",
    "completed_interactive_tutorial": "Completed Interactive Tutorial",
    "continue_to_next_step": "Continue To Next Step",
    "error_types_intro_content": "Error Types Intro Content",
    "error_types_intro_point_1": "Error Types Intro Point 1",
    "error_types_intro_point_2": "Error Types Intro Point 2",
    "error_types_intro_point_3": "Error Types Intro Point 3",
    "error_types_intro_title": "Error Types Intro Title",
    "evaluation_failed": "Evaluation Failed",
    "fallback_feedback_good": "Fallback Feedback Good",
    "fallback_feedback_improve": "Fallback Feedback Improve",
    "final_challenge_content": "Final Challenge Content",
    "final_challenge_point_1": "Final Challenge Point 1",
    "final_challenge_point_2": "Final Challenge Point 2",
    "final_challenge_point_3": "Final Challenge Point 3",
    "final_challenge_title": "Final Challenge Title",
    "find_array_out_of_bounds_error": "Find Array Out Of Bounds Error",
    "find_missing_null_check_error": "Find Missing Null Check Error",
    "find_string_comparison_by_ref_error": "Find String Comparison By Ref Error",
    "good_review_example_content": "Good Review Example Content",
    "good_review_example_lesson": "Good Review Example Lesson",
    "good_review_example_point_1": "Good Review Example Point 1",
    "good_review_example_point_2": "Good Review Example Point 2",
    "good_review_example_point_3": "Good Review Example Point 3",
    "good_review_example_text": "Good Review Example Text",
    "good_review_example_title": "Good Review Example Title",
    "good_review_strength_1": "Good Review Strength 1",
    "good_review_strength_2": "Good Review Strength 2",
    "good_review_strength_3": "Good Review Strength 3",
    "guided_practice_content": "Guided Practice Content",
    "guided_practice_point_1": "Guided Practice Point 1",
    "guided_practice_point_2": "Guided Practice Point 2",
    "guided_practice_point_3": "Guided Practice Point 3",
    "guided_practice_title": "Guided Practice Title",
    "introduction_content": "Introduction Content",
    "introduction_point_1": "Introduction Point 1",
    "introduction_point_2": "Introduction Point 2",
    "introduction_point_3": "Introduction Point 3",
    "introduction_title": "Introduction Title",
    "invalid_step": "Invalid Step",
    "look_for_boundary_conditions": "Look For Boundary Conditions",
    "look_for_logic_problems": "Look For Logic Problems",
    "look_for_null_issues": "Look For Null Issues",
    "look_for_syntax_errors": "Look For Syntax Errors",
    "missing_null_check_explanation": "Missing Null Check Explanation",
    "missing_null_check_pattern_description": "Missing Null Check Pattern Description",
    "missing_null_check_tip": "Missing Null Check Tip",
    "no_patterns_available": "No Patterns Available",
    "pattern_recognition_content": "Pattern Recognition Content",
    "pattern_recognition_point_1": "Pattern Recognition Point 1",
    "pattern_recognition_point_2": "Pattern Recognition Point 2",
    "pattern_recognition_point_3": "Pattern Recognition Point 3",
    "pattern_recognition_title": "Pattern Recognition Title",
    "poor_review_example_content": "Poor Review Example Content",
    "poor_review_example_lesson": "Poor Review Example Lesson",
    "poor_review_example_point_1": "Poor Review Example Point 1",
    "poor_review_example_point_2": "Poor Review Example Point 2",
    "poor_review_example_point_3": "Poor Review Example Point 3",
    "poor_review_example_text": "Poor Review Example Text",
    "poor_review_example_title": "Poor Review Example Title",
    "poor_review_problem_1": "Poor Review Problem 1",
    "poor_review_problem_2": "Poor Review Problem 2",
    "poor_review_problem_3": "Poor Review Problem 3",
    "recognizing_patterns": "Recognizing Patterns",
    "sample_code_explanation": "Sample Code Explanation",
    "string_comparison_by_ref_explanation": "String Comparison By Ref Explanation",
    "string_comparison_by_ref_pattern_description": "String Comparison By Ref Pattern Description",
    "string_comparison_by_ref_tip": "String Comparison By Ref Tip",
    "tutorial_complete": "Tutorial Complete",
    "tutorial_welcome": "Tutorial Welcome",
    "types_of_errors": "Types Of Errors",
    "understanding_code": "Understanding Code",
    "unknown_step_type": "Unknown Step Type",
    "your_turn_practice": "Your Turn Practice",
}